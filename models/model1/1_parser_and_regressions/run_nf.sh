...
nextflow -log $PWD/log/nextflow.log run pipe.nf --dnarep_marks $PWD/input_lists/dnarep_marks.csv \
												...
												--memory_process5_2 10 \
												--memory_process6_1 15 \
												--memory_process6_2 15 \
												-resume #\ -with-tower
