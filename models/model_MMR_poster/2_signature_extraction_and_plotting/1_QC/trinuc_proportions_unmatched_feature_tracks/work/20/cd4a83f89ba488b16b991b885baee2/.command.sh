...
then
    ...
    then
        ...
        conda activate R
        Rscript /g/strcombio/fsupek_data/users/malvarez/projects/RepDefSig/models/model_MMR_poster/2_signature_extraction_and_plotting/1_QC/trinuc_proportions_unmatched_feature_tracks/bin/1_list_medians_scores.R RnaSeq /g/strcombio/fsupek_cancer3/malvarez/chromatin_info/rna_seq/bins_histone_marks_rnaseq_pooled_fran/fran_legacy_parsed/RnaSeq-txnStrandCorrected_pooled8_merged_2bins.bed
    else
