...
map_features = ifelse(interactive(),
                      yes = Sys.glob(paste0("../work/[[:alnum:]][[:alnum:]]/*/map_features_chr21.tsv")),
                      no = args[2]) %>% 
  read_tsv()
...
median_scores = ifelse(interactive(),
                       yes = lapply(list(c(Sys.glob("../work/[[:alnum:]][[:alnum:]]/*/median_score_DHS.tsv")[1],
                                           ...
                                           Sys.glob("../work/[[:alnum:]][[:alnum:]]/*/median_score_SETD2.tsv")[1],
                                           Sys.glob("../work/[[:alnum:]][[:alnum:]]/*/median_score_MSH6.tsv")[1],
                                           Sys.glob("../work/[[:alnum:]][[:alnum:]]/*/median_score_H3K36me2.tsv")[1])), 
                                    read_tsv),
